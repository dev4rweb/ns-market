<template>
    <div class="card mb-3 mb-3 p-3"
         v-if="curProdGroup.length"
    >
        <h4 class="mb-3">Противоположные по звучанию</h4>
        <div
            class="aroma-filter-wrapper"
        >
            <div
                v-for="item in curProdGroup"
                class="circle-color"
...
export default {
    ...
    mounted() {
        // console.log('AntagonistAromas', this.curProdGroup)
    }
}
</script>
